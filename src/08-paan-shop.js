...
export function createPaanOrder(basePaan, customizations) {
  ...
  const order = Object.assign({}, basePaan)
...
export function updatePrices(menu, increase) {
  ...
  const increasePrice = entries.map(([key, value]) => [key, value + increase])
  const increasePriceObj = Object.fromEntries(increasePrice)
  return increasePriceObj
